...
function TaskCard({task, deleteTask, updateTask}: Props) {
    ...
    if(isDragging){
        return (
            <div
                ...
                min-h-[100px] items-center flex text-left rounded-xl border border-rose-500 cursor-grab relative'
            ></div>
        )
    }
  ...
  return (
    <div 
      ...
      className='bg-mainBackgroundColor p-2.5 h-[100px] 
      min-h-[100px] items-center flex text-left rounded-xl hover:ring-2 hover:ring-inset hover:ring-rose-500 cursor-grab relative task'
